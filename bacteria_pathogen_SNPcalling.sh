...
#are we working in bash, or the Sapelo2 (University of Georgia specific) cluster?
  ...
  REF= $1 #${reference}  #Variable for the reference genome. first argument
  EMAIL= $2 #${email}  #Variable for the email you wish to get notifications from. second arguement
